...
//          "=================================================================="
//       << std::endl;
//   for (int layer = 1; layer < m_n_hidden_layers + 1; layer++) {
...
//     for (int j = 0; j < WIDTH; j++) {
//       std::cout
//           << "Idx " << j << " - " << my_mlp.layers[layer + 1].out[j] << ": "
//           << fwd[j + batch_size * INPUT_WIDTH + batch_size * WIDTH *
//           (layer)];
//       if (layer == m_n_hidden_layers) {

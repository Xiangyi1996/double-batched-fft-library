...
//         // python/test_to_packed_layout_coord std::cout << "(" << i * width +
//         j
//         // << "," << input_width << ", " << width
//         //           << ", "
//         //           << toPackedLayoutCoord(i * width + j, input_width,
//         width)
//         //           << ")" << std::endl;
//         weights[0].w[j * input_width + i] =
//         trainer_weights[toPackedLayoutCoord(
...
//   std::vector<bf16> w_swiftT(network.m_weightsT_matrices.size());
//   q.memcpy(w_swiftT.data(), train.m_network->m_weightsT_matrices.data(),
//            network.m_weightsT_matrices.size() * sizeof(bf16));
//   q.wait();
...
//     if (w_swiftT[i] == 0) {
//       std::cout << "Weights T Got a zero val at: " << i << ": " <<
//       w_swiftT[i]
//                 << std::endl;
//     }
//   }
...
//   std::cout << " grads with size " <<
//   train.m_network->m_grads_matrices.size()
//             << std::endl;

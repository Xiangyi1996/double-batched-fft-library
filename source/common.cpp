...
/**
 * Convert an index to a packed layout coordinate for interleaved even and odd rows.
 *
 * This function calculates the packed layout coordinate for an interleaved layout
 * where consecutive even and odd rows are interleaved. It takes an index, the number
 * of rows, and the number of columns as inputs and returns the corresponding packed
 * layout coordinate.
 *
...
/**
 * Convert a packed layout coordinate to an index for interleaved even and odd rows.
 *
 ...
 * coordinate, the number of rows, and the number of columns as inputs and returns

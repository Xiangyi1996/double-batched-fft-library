...
// //   DeviceMem<float> output = DeviceMem<float>(batch_size * output_width,
// q);
// //   DeviceMem<float> target = DeviceMem<float>(batch_size * output_width,
// q);
// //   DeviceMem<bf16> grads = DeviceMem<bf16>(batch_size * output_width, q);
// //   DeviceMem<float> losses = DeviceMem<float>(batch_size * output_width,
// q);
...
// //     model.trainer.training_step(inputs, output, target, grads, losses,
// scale,
// //                                 64);
// //   }
// //   return 0;

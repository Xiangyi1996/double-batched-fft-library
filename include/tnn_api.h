...
//         queue q; // TODO: how handle this? Is there even a better way without memcpy, as this is device to device ->
//         no
...
//   public:
//     EncodingModule(int input_width, std::string filename /* , const json &encoding_config */, std::string
//     device_name)
...
//         this->sycl_queue.memcpy(input_encoding.data(), input_tensor.data_ptr<T>(), input_encoding.size() *
//         sizeof(T)); this->sycl_queue.wait();
...
//             this->sycl_queue, m_width, output_width, n_hidden_layers, activation, output_activation,
//             encoding_config);
//     }

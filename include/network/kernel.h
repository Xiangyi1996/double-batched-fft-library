        ...
        cgh.parallel_for(
            ...
            [=](nd_item<1> item) [[intel::reqd_sub_group_size(SG_SIZE)]] {
                ...
                for (int iter = 0; iter < TM; iter++) {
                    ...
                    tmp16avalues1[iter] = *((int32_t *)(inputs_ptr + total_offset_A) + loc_id + iter * K / 2 + SG_SIZE);
                }
        ...
        cgh.parallel_for(
            ...
            [=](nd_item<1> item) [[intel::reqd_sub_group_size(SG_SIZE)]] {
                ...
                sg.store<8>(global_ptr<int32_t>((int32_t *)(intermediate_output_forward + total_offset_A)),
                            tmp16avalues0);
                sg.store<8>(global_ptr<int32_t>((int32_t *)(intermediate_output_forward + total_offset_A + 4 * WIDTH)),
                            tmp16avalues1);
